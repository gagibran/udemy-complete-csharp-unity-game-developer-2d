...
namespace Interfaces
{
    class Program
    {
        ...
        {
            var videoWorkflow = new VideoWorkflow();
            var uploadVideo = new UploadVideo();
            var changeVideoStatusInDb = new ChangeVideoStatusInDb();
            var sendEmail = new SendEmail();
            var workflowEngine = new WorkflowEngine(videoWorkflow);
            videoWorkflow.AddActivity(uploadVideo, changeVideoStatusInDb, sendEmail);
            workflowEngine.Run();
            videoWorkflow.RemoveActivity(sendEmail);
            workflowEngine.Run();
